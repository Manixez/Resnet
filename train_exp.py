...
from exp_resnet34 import create_resnet34
...
def plot_metrics(train_losses, val_losses, train_accs, val_accs):
    ...
    # Menampilkan plot
    plt.savefig('hasil_training_exp.png')
    plt.close() 

    print("\nGrafik training telah disimpan sebagai 'hasil_training.png'")

def save_metrics(train_losses, val_losses, train_accs, val_accs, filename='metrics_exp.csv'):
...
def main():
    ...
    nworkers = cpu_count - 4 if cpu_count > 4 else 1
    ...
    best_model_path = "best_exp_resnet34_model.pth"
    ...
    # Print model summary
    print(f"\nModel Summary:")
    print(f"- Architecture: ResNet-34 (trained from scratch)")
    print(f"- Initial Conv Layer: Kernel=8x8, Stride=4")
    print(f"- Transfer Learning: No (trained from scratch)")
